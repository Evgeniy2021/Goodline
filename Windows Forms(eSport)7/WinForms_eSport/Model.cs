...
namespace WinForms_eSport
{
    public class Model
    {
        private string PlayersPath = "Players.txt";
        static public List<Team> Teams = new List<Team>();
        public Model model = new Model();
        public void InitTeams()
        {
            Model.Teams.Add(new Team("Лига", 5, 10, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("Ужас", 15, 12, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("HULK", 15, 12, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("RAB", 15, 12, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("Red", 5, 10, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("King", 15, 12, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("Дикие", 15, 12, new List<Player>()
            {
            ...
            Model.Teams.Add(new Team("Зубзазуб", 15, 12, new List<Player>()
            {
